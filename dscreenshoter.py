    ...
    while True:
        ...
        if retry_session:
            ...
            if not remaining_domains and failed_domains_set:
                ...
                print(f"{len(remaining_domains)} domains still failed after previous retry. Retrying again.")
        ...
        while True:
            while True:
                try:
                    ...
                    sys.exit(0)
            if retry_choice == 'y':
                continue_retry = retry_failed_domains(session_file, output_folder, vpn_dir, max_requests, threads, timeout, webdriver_path, delay)
